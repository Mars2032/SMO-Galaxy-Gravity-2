...
static al::NameToCreator<al::createArea> areaEntries[] = {
    // custom area entries
    {"GravityParallelArea", &al::createAreaObjFunction<al::AreaObj>},
    {"GravitySegmentArea", &al::createAreaObjFunction<al::AreaObj>},
    {"GravityDiskTorusArea", &al::createAreaObjFunction<al::AreaObj>},
    {"GravityDiskArea", &al::createAreaObjFunction<al::AreaObj>},
    {"GravityConeArea", &al::createAreaObjFunction<al::AreaObj>},
    {"GravityCubeArea", &al::createAreaObjFunction<al::AreaObj>},
    {"GravityPointArea", &al::createAreaObjFunction<al::AreaObj>},
    // base area entries
